      ...
      <div className="w-full h-screen flex flex-col bg-gradient-to-tr from-indigo-50 to-indigo-200 text-slate-900 overflow-hidden">
        <header className="sticky top-0 z-20 flex items-center justify-between gap-4 px-6 py-3 bg-white/60 backdrop-blur-md shadow-sm">
          ...
          <div className="flex-1 max-w-xl mx-4">
            ...
            <div className="relative">
              ...
              />
              <svg
                className="w-5 h-5 text-slate-400 absolute right-3 top-1/2 -translate-y-1/2"
              ...
              >
                <path
                  ...
                  strokeWidth="2"
                  d="M21 21l-4.35-4.35M16.65 11A5.65 5.65 0 1 1 5.35 11a5.65 5.65 0 0 1 11.3 0z"
                />
              </svg>
            </div>
          </div>
          ...
          <div className="flex items-center gap-4">
            ...
            <Link
              ...
              className="relative inline-flex items-center gap-2 bg-indigo-600 text-white px-3 py-2 rounded-lg shadow hover:bg-indigo-700 transition"
            >
          ...
          <section className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 max-h-[500px] nobar ">
            {prods.map((item, idx) => {
              ...
              return (
                <article
                  key={key}
                  className="bg-white/95 rounded-xl shadow-md hover:shadow-xl overflow-hidden transition transform hover:-translate-y-1 h-max "
                >
                  ...
                  <div className="p-4 flex flex-col gap-3">
                    ...
                    <div className="mt-2 flex items-center justify-between gap-3">
                      <button
                        ...
                        className="flex-1 flex justify-center items-center gap-2 px-3 py-2 rounded-lg bg-indigo-600 text-white font-semibold hover:bg-indigo-700 transition"
                      >
        ...
        <footer className="py-4 bg-indigo-700 text-white text-center">
          <div className="max-w-4xl mx-auto px-4">
            <p className="text-sm">
              © {new Date().getFullYear()} Furto Shop — Built with care
            </p>
          </div>
        </footer>
      </div>
